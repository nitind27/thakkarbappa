...
export type StudentData = {
  ...
  export type Facility = {
    ...
    srNo: number; // Corresponds to Int in Prisma
  };
...
export type Supervisor = {
  ...
  export type YojanaYear = {
    yojanaYearId: number; // Represents int(11)
    yojanaYear: string; // Represents varchar(20)
    isDelete: 'Yes' | 'No'; // Represents varchar(20) with default value 'No'
    yearStatus: string; // Represents varchar(10)
  };
