...
import { clusterdata, Schooldata, TblHostel } from "@/components/type";
...
const Page = async () => {
    ...
    const breadcrumbs = [
        ...
        { label: '', title: "Mission Sikhar", href: '/missionPeak' },
    ];
    return (
        <div>
            ...
            <MissionPeak initialClusterData={clusterdata} Schooldata={Schooldata} TblHostel={TblHostel}/>
        </div>
    );
};
