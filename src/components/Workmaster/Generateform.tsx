...
import { Bank, Categorys, Representative, SubCategory, WorkMaster, WorkMasterDemo, YojanaYear } from "../type";
...
const Generateform = ({ YojnaYear, Bankdata, category, Workmasters, reprenstive }: Props) => {
                    ...
                    setWorkmaster((prevData: any) =>
                        prevData.map((cluster: any) =>
                            cluster.id == updateClusterId
                                ? {
                                    ...cluster, representative_id: categoryName,
                                    representative_name: subcategoryName,
                                    number_work: yojnayear,
                                    genratedworkdate: bankname,
                                    estimatedtotalamount: amount,
